...
function App() {
  ...
  const handleScroll2 = () => {
    setTargetPosition(new THREE.Vector3(-0.6, 0.7, 0.15));
    setTargetRotation(new THREE.Euler(0, -0.8, 0));
  ...
  const handleScroll3 = () => {
    setTargetPosition(new THREE.Vector3(0.3, 0.6, 0.03));
    setTargetRotation(new THREE.Euler(-1.4, 0, -0.55));
